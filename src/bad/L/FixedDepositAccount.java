...
class FixedDepositAccount extends BankAccount 
{
    ...
    // Overriding withdraw method and penalty applies for early withdrawal for fixed deposit accounts
    @Override
    public void withdraw(double amount) 
    {
        ...
        {
            System.out.println("Insufficient funds as penalty for early withdrawal was added ");
        }
    }
}
